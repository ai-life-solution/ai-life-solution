import HistoryInfoContainer from './_components/HistoryInfoContainer'
...
export default async function HistoryInnerPage({ params }: { params: Promise<{ order: string }> }) {
  const keyId = await params.then(params => Number(params.order))
  return <HistoryInfoContainer keyId={keyId} />
}
