...
| 우혜리 | PL, QA, FE | Food QR API연동       | [@WUHYERI](https://github.com/WUHYERI)       |
...
| 기능               | 설명                                                                                                                                 |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------ |
| **바코드 스캔**    | HTML5-QRCode 실시간 디코딩 · Quagga2 위치 추적(왼쪽/오른쪽/위/아래/중앙 안내) · 좌표계 스케일 변환 · 카메라 전환 · 햅틱 피드백 제공  |
